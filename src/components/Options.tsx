...
function Options() {
  ...
  // 10성 이하 강화 시 1+1 적용
  const handleBonusUnderTenClick = (
  ...
  const handleSuccessOnFivesClick = (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
    const checked: boolean = event.target.checked;
  ...
  // 21성 이하에서 강화 시도 시 파괴 확률 30% 감소
  const handleReduceDestroyClick = (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
    const checked: boolean = event.target.checked;
    dispatch(setReduceDestroy(checked));
  };
                  ...
                  <div className="discount-options-mvp">
                    <div className="form-check">
                      <input
                        ...
                        id="nomvp"
                        name="mvp"
                        defaultChecked={mvpRank === MVPRank.bronze}
                        onClick={() => handleMVPClick(MVPRank.bronze)}
                      />
                      <label className="form-check-label" htmlFor="nomvp">
                        브론즈
                      </label>
                    </div>
                    <div className="form-check">
                      <input
                        ...
                        id="mvpsilver"
                        name="mvp"
                        defaultChecked={mvpRank === MVPRank.silver}
                        onClick={() => handleMVPClick(MVPRank.silver)}
                      />
                      <label className="form-check-label" htmlFor="mvpsilver">
                        실버
                      </label>
                    </div>
                    <div className="form-check">
                      <input
                        ...
                        id="mvpgold"
                        name="mvp"
                        defaultChecked={mvpRank === MVPRank.gold}
                        onClick={() => handleMVPClick(MVPRank.gold)}
                      />
                      <label className="form-check-label" htmlFor="mvpgold">
                        골드
                      </label>
                    </div>
                    <div className="form-check">
                      ...
                      />
                      <label className="form-check-label" htmlFor="mvpdiared">
                        다이아/레드
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="discount-options-pcroom">
                    <div className="form-check">
                      <input
                        ...
                        type="checkbox"
                        id="pccheck"
                        checked={pcRoomApplied}
                        onChange={(e) => handlePCRoomClick(e)}
                      />
                      <label className="form-check-label" htmlFor="pccheck">
                        PC방 혜택 적용
                      </label>
                    </div>
                  </div>
        ...
        <div className="event-options">
          <div className="simul-options special-event">
            ...
            <button
              ...
              onClick={() => handleShiningStarforceClick()}
            >
              샤이닝 스타포스 적용
            </button>
          </div>
          <div className="simul-options">
            ...
            <div className="form-check">
              <input
                ...
                type="checkbox"
                id="plusone_under_10"
                checked={bonusUnderTen}
                onChange={(e) => handleBonusUnderTenClick(e)}
              />
              <label className="form-check-label" htmlFor="plusone_under_10">
                10성 이하 강화 시 1+1
              </label>
            </div>
            <div className="form-check">
              ...
              />
              <label className="form-check-label" htmlFor="dc_30">
                강화 비용 30% 할인
              </label>
            </div>
            <div className="form-check">
              <input
                ...
                type="checkbox"
                id="success_5_10_15"
                checked={successOnFives}
                onChange={(e) => handleSuccessOnFivesClick(e)}
              />
              <label className="form-check-label" htmlFor="success_5_10_15">
                5, 10, 15성에서 강화 성공 100%
              </label>
            </div>
            <div className="form-check">
              <input
                ...
                type="checkbox"
                id="reduce_destroy"
                checked={reduceDestroy}
                onChange={(e) => handleReduceDestroyClick(e)}
              />
              <label className="form-check-label" htmlFor="reduce_destroy">
                21성 이하 파괴 확률 30% 감소
              </label>
            </div>
          </div>
